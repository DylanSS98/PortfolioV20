    ...
    e((function () {
        ...
        e(document).on("click", "[data-lightbox]", lity.options("template", '<div class="lity" role="dialog" aria-label="Dialog Window (Press escape to close)" tabindex="-1"><div class="lity-wrap" data-lity-close role="document"><div class="lity-loader" aria-hidden="true">Loading...</div><div class="lity-container"><div class="lity-content"></div><div class="lity-close" data-lity-close aria-label="Close (Press escape to close)"><span class="btn-line"></span></div></div></div></div>')), e('.navbar .navbar-nav .nav-link[href^="#"]').each((function () {
            ...
            function n(e) {
                ...
                e.parents(".cd-headline").hasClass("clip") && e.parents(".cd-words-wrapper").animate({width: "2px"}, s, (function () {
                    var t;
                    t = a, e.removeClass("is-visible").addClass("is-hidden"), t.removeClass("is-hidden").addClass("is-visible"), function (e, a) {
                        e.parents(".cd-headline").hasClass("clip") && e.parents(".cd-words-wrapper").animate({width: e.width() + 10}, s, (function () {
                            setTimeout((function () {
                                n(e)
                            }), o)
                        }))
            ...
            a = e(".cd-headline"), t = i, a.each((function () {
                var a = e(this);
                if (a.hasClass("clip")) {
                    var i = a.find(".cd-words-wrapper"), s = i.width() + 10;
                    i.css("width", s)
                }
                setTimeout((function () {
        ...
        a(["#about .pricing-section .single-plan", null], [{
            ...
            columns: 1
        }, {matchMedia: "(min-width: 991.98px)", columns: 3}], "rc-mb-0"), (t = function () {
            e("#resume .skills-section .single-skill").each((function () {
                var a = Math.min(100, Math.max(0, e(this).data("percentage"))),
                    t = e(this).find(".skill-progress").outerWidth(!0), i = t - t * (a / 100);
